...
#		Honda-CBR-RR for Flightgear December 2016
...
var loop = func {
	...
	# second possibility for clutch control backspace key is setting in the Honda-CBR-RR-set.xml
	...
	if(running.getValue() == 1){
		...
		# Anti - slip regulation Honda called ASC
